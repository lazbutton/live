...
COMMENT ON COLUMN organizer_scraping_configs.event_field IS 'Nom du champ d''événement (title, description, date, end_date, price, presale_price, subscriber_price, location, image_url, organizer, category, tags, capacity, door_opening_time, address, is_full)';
