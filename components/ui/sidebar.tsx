      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex flex-row h-screen w-full overflow-hidden",
              className
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    return (
      ...
      >
          <div
            className={cn(
              "sticky top-[5px] hidden w-[var(--sidebar-width)] transition-[width,transform] duration-200 ease-linear md:flex self-start",
              side === "left"
  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          "bg-background relative flex h-screen flex-1 flex-col overflow-auto",
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "flex min-h-0 flex-1 flex-col overflow-auto group-data-[collapsible=icon]:overflow-hidden pt-[100px]",
          className
        )}
        {...props}
      />
...
const SidebarGroupContent = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn("w-full text-sm mb-2", className)}
      {...props}
    />
  )
);
